...
public class JOGLQuad implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable gLDrawable) {
        ...
        Buffer texBuffer = texture.getBuffer();
        gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, texture.getWidth(), texture.getHeight(), 0, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE, texBuffer);
