...
import com.ggervais.gameengine.math.Quaternion;
...
public class RotationMatrixTests extends TestCase {
    ...
    public void testGetIdentityFromIdentityQuaternion() {
        Quaternion quaternion = new Quaternion();
        RotationMatrix matrix = RotationMatrix.createFromQuaternion(quaternion);
    ...
    public void testCreateFromQuaternionWithValidatedValues() {
        Quaternion quaternion = new Quaternion(0.049f, 0.565f, 0.8f, 0.447f);
        RotationMatrix matrix = RotationMatrix.createFromQuaternion(quaternion);
        int a = 0;
    }
